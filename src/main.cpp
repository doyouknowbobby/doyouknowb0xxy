...
int main() {
    ...
    std::vector<uint8_t> modePins = { 22, 21, 20, 17, 16, 15, 14, 13, 12, 7, 6, 5, 4, 3, 2, keyboardPin }; // DO NOT USE PIN GP15
    ...
    // ? - GP3 - Down: Switch WFPP + Leverless
    ...
    // 0 - 0 - Start: 8 keys set / 8KRO keyboard
