...
![image](../img/vendor/rd/pico_gcc_cable.png)

#### If you are using a third party cable :
![image](../img/vendor/rd/3rd_party_cable.png)

#### If you are using a generic USB-C breakout :
![image](../img/vendor/rd/pico_usbc_breakout.png)

#### If you are using a Model U breakout :
![image](../img/vendor/rd/pico_model_u.png)
